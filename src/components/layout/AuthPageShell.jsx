...
export function AuthPageShell({ eyebrow, title, subtitle, children }) {
  return (
    <section
      className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden bg-cover bg-center px-4 py-10 sm:px-6 lg:px-8"
    ...
    >
      ...
      <div className="relative grid w-full max-w-5xl gap-8 lg:grid-cols-[0.9fr_1fr] lg:items-center">
        <div className="hidden text-white lg:block">
          ...
          <h1 className="mt-4 max-w-md text-4xl font-black leading-tight">{title}</h1>
